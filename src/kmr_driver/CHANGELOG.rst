...
* kmr_driver : Updated doxygen. Issue `#10 <https://github.com/yujinrobot/kmr_core/issues/10>`_.
...
* Improved packet integrity checking. Issue `#245 <https://github.com/yujinrobot/kmr/issues/245>`_.
* Added new protocol about custom PID gain setting. Issue `#249 <https://github.com/yujinrobot/kmr/issues/249>`_.
* Updated doxygen.
...
* Removed SetPower command packet from doxygen. It is not for external powers and unnecessary for kmr.
...
* Added simple_keyop application to control kmr directly from keyboard without ROS.
...
* Delay demo program finish so kmr can beep alive.
