...
WORKDIR=/tmp/kmr_driver_doxygen
while [ -d $WORKDIR ]; do
  WORKDIR=/tmp/kmr_driver_doxygen_$RANDOM
done
mkdir -p $WORKDIR
...
# Clone kmr repository into temporal working directory
cd $WORKDIR
git clone https://github.com/yujinrobot/kmr_core
git clone https://github.com/yujinrobot/kmr
