/**
 * @file include/kmr_driver/parameters.hpp
 *
 * @brief Parameter configuration for the kmr.
 *
 * License: BSD
...
#ifndef KMR_PARAMETERS_HPP_
#define KMR_PARAMETERS_HPP_
 ...
 *****************************************************************************/
/**
 * @brief Parameter list and validator for the kmr.
 */
class Parameters
{
public:
  ...
  std::string device_port;         /**< @brief The serial device port name [/dev/kmr] **/
  std::string sigslots_namespace;  /**< @brief The first part of a sigslot connection namespace ["/kmr"] **/
