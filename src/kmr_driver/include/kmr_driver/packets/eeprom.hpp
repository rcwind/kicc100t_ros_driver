/**
 * @file /include/kmr_driver/packets/eeprom.hpp
 *
...
#ifndef KMR_EEPROM_DATA_HPP__
#define KMR_EEPROM_DATA_HPP__
...
public:
  ...
  bool deserialise(ecl::PushAndPop<unsigned char> & byteStream)
  {
    ...
    {
      //std::cout << "kmr_node: kmr_eeprom: deserialise failed. not enough byte stream." << std::endl;
      return false;
    }
