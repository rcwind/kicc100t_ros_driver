/**
 * @file /include/kmr_driver/packets/cliff.hpp
 *
...
#ifndef KMR_CLIFF_DATA_HPP__
#define KMR_CLIFF_DATA_HPP__
...
public:
  ...
  bool deserialise(ecl::PushAndPop<unsigned char> & byteStream)
  {
    ...
    {
      //std::cout << "kmr_node: kmr_cliff: deserialise failed. not enough byte stream." << std::endl;
      return false;
    }
