/**
 * @file /include/kmr_driver/packets/unique_device_id.hpp
...
#ifndef KMR_UDID_DATA_HPP__
#define KMR_UDID_DATA_HPP__
...
public:
  ...
  bool deserialise(ecl::PushAndPop<unsigned char> & byteStream)
  {
    ...
    {
      //std::cout << "kmr_node: kmr_udid: deserialise failed. not enough byte stream." << std::endl;
      return false;
    }
