/**
 * @file kmr_driver/packets/controller_info.hpp
 *
...
#ifndef KMR_CONTROLLER_INFO_HPP__
#define KMR_CONTROLLER_INFO_HPP__
...
public:
  ...
  bool deserialise(ecl::PushAndPop<unsigned char> & byteStream)
  {
    ...
    {
      //std::cout << "kmr_node: kmr_controller_info: deserialise failed. not enough byte stream." << std::endl;
      return false;
    }
...
#endif /* KMR_CONTROLLER_INFO_HPP__ */
