/**
 * @file include/kmr_driver/packets/firmware.hpp
 *
...
#ifndef KMR_FW_DATA_HPP__
#define KMR_FW_DATA_HPP__
...
public:
  ...
  bool deserialise(ecl::PushAndPop<unsigned char> & byteStream)
  {
    ...
    {
      //std::cout << "kmr_node: kmr_fw: deserialise failed. not enough byte stream." << std::endl;
      return false;
    }
