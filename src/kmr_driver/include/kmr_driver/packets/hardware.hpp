/**
 * @file /include/kmr_driver/packets/hardware.hpp
 *
...
#ifndef KMR_HW_DATA_HPP__
#define KMR_HW_DATA_HPP__
...
public:
  ...
  bool deserialise(ecl::PushAndPop<unsigned char> & byteStream)
  {
    ...
    {
      //std::cout << "kmr_node: kmr_hw: deserialise failed. not enough byte stream." << std::endl;
      return false;
    }
