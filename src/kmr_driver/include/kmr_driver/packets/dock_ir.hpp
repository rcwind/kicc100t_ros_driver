/**
 * @file kmr_driver/packets/dock_ir.hpp
 *
...
#ifndef KMR_DOCK_IR_DATA_HPP__
#define KMR_DOCK_IR_DATA_HPP__
...
public:
  ...
  bool deserialise(ecl::PushAndPop<unsigned char> & byteStream)
  {
    ...
    {
      //std::cout << "kmr_node: kmr_dock_ir: deserialise failed. not enough byte stream." << std::endl;
      return false;
    }
